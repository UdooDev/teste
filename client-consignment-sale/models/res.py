...
class res_partner(models.Model):
    ...
    def consignment_report_cron(self):
        ...
        template_id = self.env['ir.model.data'].get_object_reference('client-consignment-sale',
...
class mail_compose_message(models.TransientModel):
    ...
    def default_get(self, fields):
        ...
        consignment_template = self.env.ref("client-consignment-sale.email_template_partner_consignment_report")
